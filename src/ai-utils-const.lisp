...
(define-constant +find-attack-pos-insecure-action+  :find-attack-position-insecure :test #'eq)
...
(define-constant +go-near-to-enemy-insecure-action+ :go-near-to-enemy-insecure     :test #'eq)
