...
(defun dump-exp-clouds ()
  (pixmap::test-clouds-exp .6 .92 "clouds.tga")
  (pixmap::test-clouds-exp .6 .92 "clouds2.tga")
  (pixmap::test-clouds-exp .0 .09 "clouds3.tga"))

(defun dump-clouds ()
  (with-lcg-seed (1)
    (pixmap::test-clouds* 100.0 "clouds.tga")
    (pixmap::test-clouds* 700.0 "clouds2.tga")
    (pixmap::test-clouds* 10.0 "clouds3.tga")))
